...
#define GOTYPE_IMAGE  		0x00000200
...
public:
    ...
    // Input functions
    virtual Object * onButtonEvent(ButtonAction * pEvent) { return NULL; };
    virtual Object * onCursorMoveEvent(int xPxl, int yPxl) { return this; };
    ...
    void centerOn(Object * pOther);
    void vCenterOn(Object * pOther);
    void hCenterOn(Object * pOther);
    ...
    // Builder
    virtual Object * build() { return this; };
    Object * withPosition(int x, int y) {
    	m_iXPxl = x; m_iYPxl = y; return this;
    }
    Object * withDimensions(int w, int h) {
