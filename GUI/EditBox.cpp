...
// Name : EditBox
// -----------------------------------------------------------------
EditBox::EditBox() : m_TextColor(1.0f, 1.0f, 1.0f, 1.0f)
{
...
// -----------------------------------------------------------------
EditBox * EditBox::withMainGeometry(ITexture ** pTex, IGeometryQuads * pGeo)
{
...
// -----------------------------------------------------------------
EditBox * EditBox::withCaretGeometry(ITexture * pTex, IGeometryQuads * pGeo) {
...
// -----------------------------------------------------------------
EditBox * EditBox::withStencilGeometry(ITexture * pTex, IStencilGeometry * pGeo) {
...
// -----------------------------------------------------------------
EditBox * EditBox::withSelectionGeometry(ITexture * pTex, IGeometryQuads * pGeo) {
...
// Name : withLabel
// -----------------------------------------------------------------
EditBox * EditBox::withLabel(string sText, fontid fontId, Color textColor, IGeometryText * pGeo) {
    m_FontId = fontId;
    m_sText = sText;
...
// -----------------------------------------------------------------
void EditBox::rebuildMainGeometry()
{
    // 9 Quads
    QuadData ** pQuads = new QuadData*[9];
...
// Name : update
// -----------------------------------------------------------------
void EditBox::update(double delta)
{
...
// Name : displayAt
// -----------------------------------------------------------------
void EditBox::displayAt(int iXOffset, int iYOffset, Color cpntColor, Color docColor)
{
    if (!m_bVisible) {
        return;
    }
...
// Name : onButtonEvent
// -----------------------------------------------------------------
Object * EditBox::onButtonEvent(ButtonAction * pEvent)
{
...
// Name : onButton1Down
// -----------------------------------------------------------------
void EditBox::onButton1Down(int xPxl, int yPxl)
{
    m_bHasFocus = true;
...
// Name : onButton1Drag
// -----------------------------------------------------------------
void EditBox::onButton1Drag(int xPxl, int yPxl)
{
    if (!hasSelectedText()) {
...
// -----------------------------------------------------------------
void EditBox::onButton1DoubleClick(int xPxl, int yPxl)
{
...
// Name : onKeyDown
// -----------------------------------------------------------------
bool EditBox::onKeyDown(unsigned char c)
{
    if (m_bHasFocus)
    {
...
// -----------------------------------------------------------------
bool EditBox::onSpecialKeyDown(InputButton key)
{
    if (m_bHasFocus) {
        int oldCaretPos = -1;
...
// Name : setText
// -----------------------------------------------------------------
void EditBox::setText(string sText)
{
    if (sText == m_sText) {
        return;
    }
...
// Name : onResize
// -----------------------------------------------------------------
void EditBox::onResize(int iOldWidth, int iOldHeight)
{
...
// -----------------------------------------------------------------
void EditBox::updateSelectionGeometry()
{
    int nbSelLines = 1;
    for (int i = m_iSelectionStart; i < m_iSelectionEnd; i++)
    {
...
// Name : getStartOfWord
// -----------------------------------------------------------------
int EditBox::getStartOfWord(int caretpos)
{
    int start = caretpos;
    if (caretpos-1 < 0) {
        return start;
...
// Name : getEndOfWord
// -----------------------------------------------------------------
int EditBox::getEndOfWord(int caretpos)
{
    int end = caretpos;
    int iLength = m_sText.length();
    if (end >= iLength) {
...
// Name : getStartOfLine
// -----------------------------------------------------------------
int EditBox::getStartOfLine(int caretpos)
{
...
// Name : getEndOfLine
// -----------------------------------------------------------------
int EditBox::getEndOfLine(int caretpos)
{
...
//// -----------------------------------------------------------------
//EditBox * EditBox::createDefaultEditBox(int iNbLines, bool bMultiLines, int wPxl, string sId)
//{
//    Texture * iTexs[9];
